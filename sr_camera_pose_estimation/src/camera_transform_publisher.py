...
class CameraTransformPublisher:
    ...
    def __init__(self, ar_marker_topic=default_ar_marker_topic, camera_image_topic=default_camera_image_topic,
                 ...
                 camera_root_frame=default_camera_root_frame, desired_camera_parent_frame=default_desired_camera_parent_frame):
        ...
        if not camera_image_topic:
            camera_image_topic = rospy.get_param('~camera_image_topic', CameraTransformPublisher.default_camera_image_topic)
        if not marker_static_tf_names:
            marker_static_tf_names = rospy.get_param('~marker_static_tf_names', CameraTransformPublisher.default_marker_static_tf_names)
        if not marker_ids:
            marker_ids = rospy.get_param('~marker_ids', CameraTransformPublisher.default_marker_ids)
        if not camera_root_frame:
            camera_root_frame = rospy.get_param('~camera_root_frame', CameraTransformPublisher.default_camera_root_frame)
        if not desired_camera_parent_frame:
            desired_camera_parent_frame = rospy.get_param('~desired_camera_parent_frame', CameraTransformPublisher.default_desired_camera_parent_frame)
...
if __name__=="__main__":
    ...
    parser.add_argument('--marker_static_tf_names', dest='marker_static_tf_names', nargs='*', required=False, default=None)
    ...
    parser.add_argument('--desired_camera_parent_frame', dest='desired_camera_parent_frame', required=False, default=None)
    args, unknown = parser.parse_known_args()
    rospy.init_node("sat_camera_transform_publisher")
    camera_transform_publisher = CameraTransformPublisher(ar_marker_topic=args.ar_marker_topic, camera_image_topic=args.camera_image_topic,
                                                          marker_static_tf_names=args.marker_static_tf_names, marker_ids=args.marker_ids,
